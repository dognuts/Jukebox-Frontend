  ...
  return (
    <section>
      <div className="mb-3.5 flex items-center justify-between">
        <h2 className="text-[15px] font-semibold" style={{ color: "#e8e6ea" }}>
          {headerLabel}
        </h2>
        <span
          className="text-xs"
          ...
          {rooms.map((room) => {
            ...
            return (
              ...
              >
                {/* Gradient header */}
                <div
                  className="relative flex h-20 items-end p-2.5"
                  style={{
                ...
                >
                  <div
                    className="absolute right-2 top-2 flex items-center gap-1 rounded-lg px-2 py-0.5 text-[10px]"
                    style={{
