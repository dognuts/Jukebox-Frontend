...
// Framer-motion-powered easter-egg visuals. This module is loaded via
// next/dynamic from EasterEggProvider only after an egg first fires, so
// framer-motion (~34KB gz) stays out of the shared layout chunk.
