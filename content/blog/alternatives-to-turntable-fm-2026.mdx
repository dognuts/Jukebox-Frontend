...
- **A room, not a feed.** The homepage is a live list of rooms you can drop into — not a follow graph, not an algorithm. [The current live room](/live) is running right now; more rooms roll out as hosts come on board.
...
<RoomCTA label="Browse the live room on Jukebox" />
