...
- **It's a room, not a playlist.** You don't need to coordinate with anyone. Walk into [the live room on Jukebox](/live) and you're immediately hearing whatever is on, alongside everyone else tuned in. The DJs are live humans (or curated playlists running on autoplay), and the other listeners are strangers from wherever.
...
<RoomCTA label="Drop into the live room on Jukebox" />
